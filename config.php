<?php
	...
	$config['sqlUser'] = 'phpmyadmin';

	// phpmyadmin password for OT server:
	$config['sqlPassword'] = 'rok223@@';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'verana';
	...
	*/
	...
	$config['website_char'] = 'ADM Verana';
	...
	*/
	...
	$config['paypal'] = array(
		'enabled' => true,
		'email' => 'verana@tuta.io', // Example: paypal@mail.com
		'currency' => 'USD',
	...
	*/
	$config['shop_offers'] = array(
		1 => array(
			...
			'itemid' => 10502,
			'count' => 1,
			'description' => "Arcane Ring (magic level +1, protection death +3%, 5mp/5hp per second) (All vocations)",
			'points' => 550,
		),
		2 => array(
			'type' => 1,
			'itemid' => 2358,
			'count' => 1,
			'description' => "Pair of verana boots 10hp/20mp every 2 seconds.",
			'points' => 700,
		),
		3 => array(
			'type' => 1,
			'itemid' => 2640,
			'count' => 1,
			'description' => "Pair of soft boots 5hp/10mp every 2 seconds.",
			'points' => 300,
		),
		4 => array(
			'type' => 1,
			'itemid' => 2431,
			'count' => 1,
			'description' => "Stonecutter axe (atk:50, def:30). Level 90 or higher.",
			'points' => 150,
		),
		5 => array(
			'type' => 1,
			'itemid' => 2400,
			'count' => 1,
			'description' => "Magic sword (Atk:48, def:35). Level 80 or higher.",
			'points' => 150,
		),
		6 => array(
			'type' => 1,
			'itemid' => 2421,
			'count' => 1,
			'description' => "Thunder hammer (Atk:49, def:35). Level 85 or higher.",
			'points' => 150,
		),
		7 => array(
			'type' => 1,
			'itemid' => 8851,
			'count' => 1,
			'description' => "Royal crossbow (Range:6, atk +5, hit% +3). Level 130 or higher.",
			'points' => 150,
		),
		8 => array(
			'type' => 1,
			'itemid' => 6529,
			'count' => 100,
			'description' => "Infernal bolts x100 (Atk:55) Level 70 or higher.",
			'points' => 5,
		),
		9 => array(
			'type' => 4,
